...
<div id="content-area" class="wrapper archives">
	...
	<?php //if ( have_posts() ) : ?>
		...
		// SHOW RESEARCH-TEAM OF AXE
		// sedoo_labtools_get_associate_content_arguments('Research teams', 'sedoo-research-team', 'sedoo-theme-labo', '-1', '0');
		sedoo_labtools_get_associate_content_arguments('Research teams', 'sedoo-research-team', 'sedoo-axe-tag', '-1', '0');

		// SHOW PLATFORM OF AXE
        sedoo_labtools_get_associate_content_arguments('Platforms', 'sedoo-platform', 'sedoo-axe-tag', '-1', '0');
