...
<div id="content-area" class="wrapper archives">
	...
	<?php //if ( have_posts() ) : ?>
		...
		$tax_slug = get_query_var( 'sedoo-platform-tag' );
			/* Start the Loop */
		// 	
        ...
        // SHOW PLATFORM OF PLATFORM TAG
        sedoo_labtools_get_associate_content_arguments('Projects', 'sedoo-project', 'sedoo-project-tag', '-1', '0');
        
		// SHOW EVENT OF THEME
		// sedoo_labtools_get_associate_content_arguments('Evenements', 'event', 'sedoo-theme-labo', '3', '0');

		// SHOW RESEARCH-TEAM OF THEME
		sedoo_labtools_get_associate_content_arguments('Research teams', 'sedoo-research-team', 'sedoo-project-tag', '-1', '0');
